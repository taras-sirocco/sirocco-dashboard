...
export const Workers: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description:
          'Визначає, який екран бачить людина на планшеті: монтажник — звичайний потік задач, бригадир — контроль якості (/quality), власник — зведені звіти й керування (/owner).',
      },
    },
    {
      name: 'active',
